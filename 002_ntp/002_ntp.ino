...
const char* ssid = "MERCURY_82A004";  //所接入的无线网络名称
const char* password = "19730822";  
...
void setup() {
 ...
 //如果Wifi状态不是WL_CONNECTED，则表示连接失败
  ...
  // extern "C" void configTime(long timezone, int daylightOffset_sec, const char* server1, const char* server2 = nullptr, const char* server3 = nullptr);
