...
#include <WiFiUdp.h>
WiFiUDP udp;
IPAddress sip(192, 168, 26, 29);//本地IP
IPAddress sip1(192, 168, 26, 1);//本地网关
...
IPAddress Serverip(192, 168, 26, 4);//上位机远程IP
unsigned int localPort = 9999;//本地端口
unsigned int remoteport = 9999;//远程端口
const char *ssid = "JYWHD-26";
const char *password = "jc18806863286";
const char *ssid1 = "ZhangJiaChen";//AP
const char *password1 = "12345678";//AP
char packetBuffer[255];//收发缓冲区

void setup() {
  Serial.begin(74880);//初始化串口波特率
